...
export const CONTROLLER_PRESETS: ControllerPresetInfo[] = [
  {
    ...
    badge: "Illustration theme",
    description:
      "Stylized controller illustration, not a hardware identification",
  },
  {
    id: "x20-pro-white",
    name: "Light illustration",
    badge: "Illustration theme",
    description:
      "Stylized light controller illustration, not a hardware identification",
  },
];
